  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-800/30 rounded-xl p-6">
        ...
        <div className="bg-zinc-900/50 rounded-lg p-4 mb-4 border border-zinc-700">
          <div className="text-xs font-medium text-zinc-400 uppercase mb-2">
            Churn Risk Analysis
          </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-zinc-900/50 rounded-lg p-3 border border-zinc-700">
            <div className="text-xs text-zinc-400 mb-1">Activity</div>
          ...
          <div className="bg-zinc-900/50 rounded-lg p-3 border border-zinc-700">
            <div className="text-xs text-zinc-400 mb-1">Monetization</div>
            <div className="text-lg font-bold text-white">
          ...
          <div className="bg-zinc-900/50 rounded-lg p-3 border border-zinc-700">
            <div className="text-xs text-zinc-400 mb-1">Loyalty</div>
            <div className="text-lg font-bold text-white">
            ...
            {insights.recommendations.map((rec, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className="text-xs text-zinc-500">{rec.timeline}</span>
                </div>
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-6">
        ...
        <p className="text-sm text-zinc-300">{insights.lifetimeValue.reasoning}</p>
      </div>
    </div>
  );
}
